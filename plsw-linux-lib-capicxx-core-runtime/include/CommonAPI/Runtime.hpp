...
public:
    ...
    template<typename Stub_>
    COMMONAPI_METHOD_EXPORT bool registerDynamicService(const std::string &_domain,
        const std::string &_template_instance,
        const std::string &_instance,
        std::shared_ptr<Stub_> _service,
        const ConnectionId_t &_connectionId = DEFAULT_CONNECTION_ID) {
...
private:
    ...
    COMMONAPI_METHOD_EXPORT std::shared_ptr<Proxy> createDynamicProxy(const std::string &, const std::string &, const std::string &, const std::string &,
        const ConnectionId_t &);
    COMMONAPI_METHOD_EXPORT std::shared_ptr<Proxy> createDynamicProxy(const std::string &, const std::string &, const std::string &, const std::string &,
        std::shared_ptr<MainLoopContext>);
    ...
    COMMONAPI_METHOD_EXPORT bool registerDynamicStub(const std::string &, const std::string &, const std::string &, const std::string &,
        std::shared_ptr<StubBase>, const ConnectionId_t &);
    COMMONAPI_METHOD_EXPORT bool registerDynamicStub(const std::string &, const std::string &, const std::string &, const std::string &,
        std::shared_ptr<StubBase>, std::shared_ptr<MainLoopContext>);
